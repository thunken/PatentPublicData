...
public class FileIterator {
	 ...
	 * Iterator for Files
	 *
	 * If directory is passed, iterator includes all files in the directory. If
	 * single file is passed, iterator includes the single file.
	 *
	 * @param directory
	 * @param
	 * @return
	 * @throws FileNotFoundException
	 */
	public static Iterator<File> getFileIterator(File file, String[] fileExts, boolean recursive)
			throws FileNotFoundException {
		if (file.isDirectory()) {
