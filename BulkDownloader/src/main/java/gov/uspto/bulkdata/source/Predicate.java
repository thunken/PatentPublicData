...
public class Predicate implements java.util.function.Predicate<String> {
	...
	/*
	 * @XmlElement(name = "datePattern") public void setDatePattern(String
	 * datePattern, String dateRange) { new DateRange(); fileFilerList.add(new
	 * RegexFileDateFilter(pattern)); }
	 */
