...
/**
 * ClassificationItem becomes a tree of ClassificationItems, each
 * ClassificationItem can have sub ClassificationItems.
 * 
 * <p>
 * 
 * <pre>
...
public class ClassificationItem {
	...
	/**
	 * Iterator which walks the ClassificationItem Tree, iterating over items and
	 * each item's sub-items.
	 */
