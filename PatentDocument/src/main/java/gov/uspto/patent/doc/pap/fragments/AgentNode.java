...
public class AgentNode extends DOMFragmentReader<List<Agent>> {
	...
	public List<Agent> read() {
		...
		/*
		 * Following name elements are name used for mailing. name-2 is often empty.
		 * company name can occur in either name-1 or name-2
		 * 
		 * Variations: <name-1>PERSON OR ENTITY NAME</name-1> <name-2>COMPANY
		 * NAME</name-2>
		 * 
		 * <name-1>COMPANY NAME</name-1> <name-2>FLOOR</name-2>
		 */
		...
		String addressName = name2Str.isEmpty() ? name1Str : name1Str + "; " + name2Str; // using semi-colon since
																							// commas may occur within
																							// name.
