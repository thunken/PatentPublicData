 ...
 * 
 * In 1978 the Country Codes changed, some where reused, but since then new
 * countries have been established and borders have changed.
 *
 * The mapping allows for possible country codes reused, year range can be used
 * to disambiguate the correct country code.
 *
 * <pre>
...
public class CountryCodeHistory {
	...
	static {
		...
		// Note "EN" and "UK" are not an official country codes though they are used in
		// addresses.
		COUNTRY_MAP.put("EN", new CountryCodeHistoric("United Kingdom", 1922, FORMAT_CHANGE_DATE, CountryCode.GB)); // 1922
																													// Ireland
																													// broke
																													// union
																													// with
																													// United
																													// Kingdom.
		COUNTRY_MAP.put("UK", new CountryCodeHistoric("United Kingdom", 1922, FORMAT_CHANGE_DATE, CountryCode.GB)); // 1922
																													// Ireland
																													// broke
																													// union
																													// with
		...
		COUNTRY_MAP.put("CE", new CountryCodeHistoric("Chile", 1818, FORMAT_CHANGE_DATE, CountryCode.CL)); // 1883
																											// gained
																											// territory
																											// from Peru
																											// and
		...
		COUNTRY_MAP.put("CS", new CountryCodeHistoric("Czechoslovakia", 1918, 1992, CountryCode.CZ, CountryCode.SK)); // country
																														// split
																														// into
																														// two.
		COUNTRY_MAP.put("CV", new CountryCodeHistoric("Vatican City State", 842, FORMAT_CHANGE_DATE, CountryCode.VA));
		COUNTRY_MAP.put("DA", new CountryCodeHistoric("Dahomey", 1974, FORMAT_CHANGE_DATE, CountryCode.BJ)); // Dahomey
																												// Name
																												// changed
																												// to
																												// Benin.
		...
		COUNTRY_MAP.put("DD", new CountryCodeHistoric("East Germany", 1978, 1990, CountryCode.DE)); // East and West
																									// Germany merge.
		COUNTRY_MAP.put("DR", new CountryCodeHistoric("Dominican Republic", 1924, FORMAT_CHANGE_DATE, CountryCode.DO));
		COUNTRY_MAP.put("EA", new CountryCodeHistoric("Ethiopia", 1889, FORMAT_CHANGE_DATE, CountryCode.ET)); // borders
																												// reshaped
																												// 1889??
		...
		COUNTRY_MAP.put("FL", new CountryCodeHistoric("Liechtenstein", 1945, FORMAT_CHANGE_DATE, CountryCode.LI)); // 1945
																													// end
																													// of
																													// World
																													// War
		...
		COUNTRY_MAP.put("IB",
				new CountryCodeHistoric("International Patent Institute", 1947, FORMAT_CHANGE_DATE, CountryCode.WO)); // existed
																														// 1947-1978;
																														// merged
																														// with
																														// EPO.
		...
		COUNTRY_MAP.put("KN", new CountryCodeHistoric("North Korea", 1953, FORMAT_CHANGE_DATE, CountryCode.KP)); // Korean
																													// War
																													// (1950-1953)
		COUNTRY_MAP.put("KS", new CountryCodeHistoric("South Korea", 1953, FORMAT_CHANGE_DATE, CountryCode.KR)); // Korean
																													// War
																													// (1950-1953)
		COUNTRY_MAP.put("UV", new CountryCodeHistoric("Upper Volta", 1958, FORMAT_CHANGE_DATE, CountryCode.BF));
		COUNTRY_MAP.put("RC", new CountryCodeHistoric("China", 1949, FORMAT_CHANGE_DATE, CountryCode.CN)); // 1895
																											// borders
																											// reshaped
																											// after war
																											// (Taiwan
		...
		COUNTRY_MAP.put("KU", new CountryCodeHistoric("Kuwait", 1922, FORMAT_CHANGE_DATE, CountryCode.KW)); // borders
																											// reshaped
																											// 1922.
		...
		COUNTRY_MAP.put("PO", new CountryCodeHistoric("Poland", 1945, FORMAT_CHANGE_DATE, CountryCode.PL)); // 1945 end
																											// of World
																											// War 2
																											// borders
																											// reshaped.
		COUNTRY_MAP.put("PP", new CountryCodeHistoric("Papua New Guinea", 1975, FORMAT_CHANGE_DATE, CountryCode.PG)); // sovereignty
																														// in
																														// 1975.
		COUNTRY_MAP.put("RU", new CountryCodeHistoric("Romania", 1940, FORMAT_CHANGE_DATE, CountryCode.RO)); // borders
																												// reshaped
																												// 1940.
		...
		COUNTRY_MAP.put("YD", new CountryCodeHistoric("South Yemen", 1978, 1990, CountryCode.YE)); // North and South
																									// Yemen merge.
		COUNTRY_MAP.put("YU",
				new CountryCodeHistoric("Yugoslavia/Serbia and Montenegro", 1922, FORMAT_CHANGE_DATE, CountryCode.YU)); // country
																														// renamed
																														// but
																														// kept
																														// old
		...
		COUNTRY_MAP.put("ZR",
				new CountryCodeHistoric("Central African Republic", 1960, FORMAT_CHANGE_DATE, CountryCode.CF));
		COUNTRY_MAP.put("ZR", new CountryCodeHistoric("Zaire", 1971, FORMAT_CHANGE_DATE, CountryCode.CD)); // Zaire
																											// (1971-1997)
																											// now
																											// Democratic
																											// Republic
																											// of the
																											// Congo.
		COUNTRY_MAP.put("CB", new CountryCodeHistoric("Zaire", 1978, FORMAT_CHANGE_DATE, CountryCode.CD)); // Democratic
																											// Republic
																											// of the
																											// Congo CB
																											// ZR/CD
		...
		COUNTRY_MAP.put("SU", new CountryCodeHistoric("Soviet Union (USSR)", 1922, 1991, CountryCode.SU)); // split into
																											// multiple
																											// counties,
																											// for now
																											// keep as
																											// original.
		COUNTRY_MAP.put("NC", new CountryCodeHistoric("New Caledonia", 1978, 2016, CountryCode.UNDEFINED)); // territory
																											// of
																											// France,
																											// removed
																											// April
																											// 2016.
		COUNTRY_MAP.put("NF", new CountryCodeHistoric("Norfolk Island", 1978, 2016, CountryCode.UNDEFINED)); // territory
																												// of
																												// Australia,
																												// removed
																												// April
