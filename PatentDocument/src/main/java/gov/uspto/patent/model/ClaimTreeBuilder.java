...
/**
 * Build Claim Tree by adding child claims to each claim a claim is dependent
 * on; In other words adding the current claim as a child to the claim
 * referenced.
 * 
...
public class ClaimTreeBuilder {
	...
	/**
	 * Recursively iterate over claims adding it's tree level or depth to each
	 * claim.
	 * 
	 * @param claim
	 */
