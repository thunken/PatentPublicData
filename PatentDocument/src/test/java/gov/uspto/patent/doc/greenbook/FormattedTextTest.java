...
public class FormattedTextTest {
	...
	public void SimpleHtml() {
		...
		expectStb.append(
				"<p id=\"P-0001\">Paragraph text, referenceing <a class=\"figref\" idref=\"FIG-1\" id=\"FR-0001\">FIG-1</a> is a side elevational view</p>\n");
		expectStb.append(
				"<p id=\"P-0002\">More text now referenceing <a class=\"figref\" idref=\"FIG-2B\" id=\"FR-0002\">FIG-2B</a> is a top view</p>\n");
