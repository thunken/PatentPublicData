...
public class GrantParserTest {
	...
	@Test
	public void readSamples2004() throws PatentReaderException, IOException, IllegalAccessException,
	...
	@Test
	public void readSamples2006() throws PatentReaderException, IOException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		GrantParser xmlGrant = new GrantParser();
	...
	@Test
	public void readSamples2014() throws PatentReaderException, IOException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		GrantParser xmlGrant = new GrantParser();
