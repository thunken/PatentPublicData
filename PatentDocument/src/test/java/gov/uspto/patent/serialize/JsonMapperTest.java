...
public class JsonMapperTest {
	...
	public void buildJsonTest() throws InvalidDataException, IOException {
		...
		patent.setInventor(Arrays.asList(new Inventor(new NamePerson("Bob", "Inventee"),
				new Address("123 Main St", "Alexandria", "VA", "22314", CountryCode.US))));
		patent.setAssignee(Arrays.asList(new Assignee(new NameOrg("Inventee Inc."),
				new Address("123 Main St", "Alexandria", "VA", "22314", CountryCode.US))));
		...
		desc.addSection(
				new DescriptionSection(DescSection.BRIEF_SUMMARY, "Brief Summar Desc Text", textParserNormalizer));
		desc.addSection(
				new DescriptionSection(DescSection.DETAILED_DESC, "Detailed Description Text", textParserNormalizer));
